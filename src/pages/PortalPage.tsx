...
export default function PortalPage() {
  ...
  const myTickets = mockTickets.filter((t) => t.createdBy === portalUser.id);
            ...
            <div className="animate-fade-in">
              ...
              <div className="bg-card rounded-xl border border-border p-5 shadow-soft">
                ...
                <form onSubmit={handleSubmit} className="space-y-3.5">
                  ...
                  <button type="submit" className="w-full h-9 bg-primary text-primary-foreground rounded-lg text-[13px] font-medium hover:bg-primary/90 transition-colors">Abrir Demanda</button>
                </form>
              </div>
            </div>
          )}
